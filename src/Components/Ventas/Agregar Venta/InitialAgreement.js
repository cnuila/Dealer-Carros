...
export default function InitialAgreement() {
    return (
        <form>
            <div className="flex flex-col h-72 bg-gray-900 max-w-3xl mx-2 lg:mx-auto rounded-b-lg shadow-2xl">
                <div className="grid grid-cols-1 md:grid-cols-2 p-3">
                    ...
                    <div className="block px-8 pt-5">
                        ...
                        <input type="text" className="block bg-gray-900 text-gray-200 ml-4 px-2 py-2 w-11/12 border-b-2 border-gray-800 focus:border-gray-700 placeholder-gray-500 focus:placeholder-gray-400 focus:outline-none" name="proveedor" placeholder="Ej. Grupo Q" required/>
                    </div>
