...
export default function ImagenPrincipal(props) {
    ...
    const fotoLista = (
        <div className="grid relative bg-gray-400 rounded-lg h-64 w-10/12 place-self-center">
    ...
    const sinFoto = (
        <div className="grid relative h-64 w-10/12 bg-gray-400 hover:bg-gray-500 rounded-lg place-self-center">
            <input type="file" className="absolute z-10 opacity-0 cursor-pointer w-full h-full" accept="image/jpeg,image/jpg" onChange={subirFoto} required />
            <div className="z-0 grid grid-cols-1 place-content-center h-full">
