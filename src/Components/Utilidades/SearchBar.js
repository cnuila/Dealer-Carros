...
export default function SearchBar(props) {
    ...
    return (
        <div className="flex flex-col relative w-2/5" onBlur={handleOnBlur} onFocus={handleOnFocus}>
            <div className={`group flex flex-row bg-gray-200 ${roundedSearch}`}>
                ...
                <input type="text" value={palabra} className="bg-gray-200 w-10/12 text-gray-900 pr-4 py-2  focus:outline-none" name="searchBar" placeholder="Buscar Marca, Modelo, o Proveedor" onKeyDown={handleOnKeyDown} onChange={handleOnChange} />
            </div>
            {mostrarSugerencias
                ? (
