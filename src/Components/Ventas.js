    ...
    return (
        <div className="bg-gray-100 h-screen" >
            ...
            <div className="py-6" >
                ...
                <div className="md:flex md:flex-row border-l-8 border-indigo-900 p-2 cursor-default my-4 mx-8 rounded-md md:rounded-lg bg-white shadow-lg hover:bg-gray-200 cursor-pointer">
                ...
                <div className="md:flex md:flex-row border-l-8 border-indigo-900 p-2 cursor-default my-4 mx-8 rounded-md md:rounded-lg bg-white shadow-lg hover:bg-indigo-100 cursor-pointer">
