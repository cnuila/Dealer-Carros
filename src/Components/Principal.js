      ...
      return (
        <div>
          <Estado
            ...
            color={boton.color}
            clicEstadoCarro={this.clicEstadoCarro}
          ></Estado>
        </div>
      );
    });
      ...
      <div className="bg-gray-100">
        ...
        <nav class="flex items-center justify-between flex-wrap bg-gray-900 p-3">
          <div class="flex items-center flex-shrink-0 text-white mr-6">
            <span class="font-bold text-4xl tracking-tight pl-10">
              Santos Motors
            </span>
          </div>
          <div class="flex items-center">
            <button class="focus:outline-none bg-gray-900 hover:bg-gray-800 text-gray-100 font-bold py-1 px-4 rounded inline-flex items-center">
              <svg
                class="w-8 h-8 mr-3 fill-current text-gray-100"
            ...
            <button className="focus:outline-none bg-gray-900 hover:bg-gray-800 text-gray-100 font-bold py-2 px-4 rounded inline-flex items-center">
              <svg
                className="w-6 h-6 mr-2 fill-current text-gay-100"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 20 20"
              >
