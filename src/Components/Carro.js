    ...
    return (
        <div className="max-w-xs px-4 transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
            <div className="relative pb-48">
                <img className="absolute h-full w-full object-cover rounded-lg shadow-md" src={foto} alt="Carro" />
            </div>
            <div className="relative px-4 -mt-10">
                <div className="px-6 py-4 bg-gray-900 rounded-lg shadow-xl">
                    ...
                    <div className="text-gray-500 text-sm font-medium mb-2">${coma()}</div>

                    <div className="grid grid-cols-4">
                        <div className="text-green-500 text-sm mb-2 font-semibold">{estado}</div>
                        <div></div>
                        <div></div>
                        <div className="flex justify-end text-gray-500 text-sm font-semibold">{tipoTitulo}</div>
                    </div>
